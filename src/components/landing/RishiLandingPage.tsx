    ...
    <div id="top" className="min-h-screen overflow-hidden bg-[#fffaf3] text-[#163b45]">
      <header className="sticky top-0 z-30 border-b border-[#e8ded1]/80 bg-[#fffaf3]/90 px-5 py-4 backdrop-blur-md sm:px-8">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-5">
          ...
          <a href="https://sandipprodhan.in" className="inline-flex items-center gap-1.5 rounded-full bg-[#163b45] px-4 py-2 text-sm font-bold text-white transition-transform hover:-translate-y-0.5">
      ...
      <main>
        ...
        <section id="fundlens" className="border-t border-[#e8ded1] bg-[#f7c96d] px-5 py-14 sm:px-8">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6">
            ...
            <a href="https://sandipprodhan.in" className="inline-flex items-center gap-2 rounded-full bg-[#163b45] px-5 py-3 text-sm font-bold text-white">Explore Fund Lens <ArrowUpRight className="size-4" /></a>
          </div>
        </section>
      </main>
